export default {
  async fetch(request, env) {
    ...
    // 🔒 จำกัดโดเมน
    const allowed = "huay.toolepic.com";
    ...
    try {
      ...
      const response = await fetch(
        "https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-latest:generateContent?key=" + env.GEMINI_KEY,
        {
          method: "POST",
          headers: {
      ...
      return new Response(result, {
        headers: {
          ...
          "Access-Control-Allow-Origin": "https://huay.toolepic.com"
        }
      });
